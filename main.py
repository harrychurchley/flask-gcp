...
bq_client = bigquery.Client() #project='flask-gcp-db'
...
def top_n_scorers():
    query = """
        ...
        FROM `flask-gcp-db.football_data.arsenal_03_04`
...
def root():
    ...
    return render_template(
        'index.html',
        user_data=claims, error_message=error_message, times=times, top_scorers=top_scorers)
